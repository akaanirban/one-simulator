...
/**
 * Map based stationary movement model which spawns Stationary nodes using the
 * roads of a SimMap such that the nodes are not spawned outside the map.
 */
public class MapBasedStationaryMovement extends MovementModel {
	 ...
	 */
	public MapBasedStationaryMovement(Settings settings) {
		super(settings);
		map = readMap();
	 ...
	 */
	public MapBasedStationaryMovement(Settings settings, SimMap newMap, int nrofMaps) {
		super(settings);
		map = newMap;
	 ...
	 */
	protected MapBasedStationaryMovement(MapBasedStationaryMovement mbm) {
		super(mbm);
	...
	@Override
	public MapBasedStationaryMovement replicate() {
		return new MapBasedStationaryMovement(this);
	}
